...
function Hero({ slidesData, currentSlide, setCurrentSlide }) {
      ...
      <div className="w-full mt-20 flex flex-col lg:flex-row justify-between items-center h-[380px] md:h-[600px] py-10 lg:py-0">
        <div className="flex max-w-[700px] flex-col text-white mb-10 lg:mb-0 w-full lg:w-auto text-center lg:text-left">
          <button
            ...
            className="relative cursor-pointer py-3 px-7 mb-6 w-[140px] font-archivo text-base text-white rounded-4xl backdrop-blur-md bg-white/30 mx-auto lg:mx-0"
          >
            Contact Us
        ...
        <div
          className="relative hidden md:flex w-full max-w-[300px]"
