...
function Header({ backgroundImage, settings, categories }) {
  ...
  const [showLoginForm, setShowLoginForm] = useState(true); // Toggle between login/register
  ...
  return (
    ...
    transition duration-300 filter
    ${
      !isScrolled
        ? "brightness-0 invert" // make it white
          ...
          <div className="hidden lg:flex items-center gap-10">
            ...
            >
              ...
              >
                ...
                <div
                  className={`
    absolute font-archivo right-0 mt-2 w-96 border-[1.2px] border-white rounded-3xl shadow-xl z-50 overflow-hidden
  ...
  `}
                ...
                >
                  <div className="bg-white/70 bg-opacity-15 backdrop-blur-sm p-4">
                    {isAccountPage ? (
                      /* Logout modal */
                      <>
                        {/* <div className="space-y-3 pt-4">
          <p className="text-center text-gray-800 font-medium">
            {t("account.loggedInAs", { user: settings?.user?.name })}
          </p>
        </div> */}
                        ...
                        <div className="flex justify-center ">
                          <button
                            onClick={() => {
                              // call your logout handler here if needed
                              // settings?.onLogout();
                              setShowUserDropdown(false);
                              router.push("/"); // Navigates to index page
                            }}
                            className="px-14 py-2 flex items-center gap-5 bg-brand text-white rounded-3xl hover:bg-brand/65 transition-colors"
                          >
                            <CiLogout />
                            Log out
                          </button>
                      ...
                      <>
                        <div className="space-y-3 pt-4">
                          <input
                            ...
                            className="w-full px-3 py-2 border border-white rounded-3xl bg-white focus:outline-none focus:ring-2 focus:ring-brand focus:border-transparent"
                          ...
                          <input
                            ...
                            className="w-full px-3 py-2 border border-white bg-white rounded-3xl focus:outline-none focus:ring-2 focus:ring-brand focus:border-transparent"
                        ...
                        <div className="flex justify-between mt-4">
                          <button
                            className="text-sm font-archivo text-brand hover:underline"
                            onClick={(e) => {
                              e.preventDefault();
                              e.stopPropagation();
                          ...
                          <Link href="/account" passHref>
                            <button className="px-8 font-archivo py-2 bg-brand text-white rounded-3xl hover:bg-brand-dark transition-colors">
                              Login
                            </button>
                          </Link>
                        </div>
                      ...
                      <>
                        <div className="space-y-3 pt-4">
                          <input
                            type="text"
                            placeholder="Username"
                            className="w-full px-3 py-2 border bg-white border-white rounded-3xl focus:outline-none focus:ring-2 focus:ring-brand focus:border-transparent"
                            value={formData.username}
                            onChange={(e) =>
                              setFormData({
                                ...formData,
                        ...
                        <div className="flex justify-between mt-4">
                          ...
                          <Link href="/account" passHref>
                            <button className="px-8 py-2 bg-brand text-white rounded-3xl hover:bg-brand-dark transition-colors">
                              Register
                            </button>
                          </Link>
                        </div>
              ...
              {/* ===== End of new code ===== */}
              <LanguageSwitcher isScrolled={isScrolled}    categories={categories}    selectedService={selectedService} />
            </div>
          </div>
